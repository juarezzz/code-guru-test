interface PolytagAdminInviteEmail {
  base_url: string;
  email: string;
}

export const polytag_admin_invite_email = ({
  base_url,
  email,
}: PolytagAdminInviteEmail) => {
  return `<!DOCTYPE html>
      ...
      <div class="content">
        <img src="https://polytag-${
          ...
          <div class="card">
              ...
              <p>You were invited to join Polytag Admin by your colleague.</p>
