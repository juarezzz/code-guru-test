interface PolytagBrandForgotPasswordEmail {
  six_digit_code: string;
  email: string;
}

export const polytag_brand_forgot_password_email = ({
  six_digit_code,
  email,
}: PolytagBrandForgotPasswordEmail) => {
  return `
  <!DOCTYPE html>
  ...
  <body>
      <div class="content">
        ...
        <div class="card">
          ...
          <p>To proceed in your forgot password flow, please use this six-digit security code:</p>
