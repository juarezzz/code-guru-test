interface PolytagUserInviteEmail {
  base_url: string;
  email: string;
}

export const polytag_printer_user_invite_email = ({
  base_url,
  email,
}: PolytagUserInviteEmail) => {
  return `<!DOCTYPE html>
  ...
  <body>
        <div class="content">
            ...
            <div class="card">
                ...
                <p>You were invited to create a Polytag Printer account</p>
