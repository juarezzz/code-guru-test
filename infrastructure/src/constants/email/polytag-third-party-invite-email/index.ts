interface PolytagMRFUserInviteEmail {
  base_url: string;
  email: string;
}

export const polytag_third_party_user_invite_email = ({
  base_url,
  email,
}: PolytagMRFUserInviteEmail) => {
  return `<!DOCTYPE html>
  ...
  <body>
        <div class="content">
            ...
            <div class="card">
                ...
                <p>You were invited to create a Polytag third-party account</p>
    ...
    email,
          ...
          <div class="footer">
              ...
              <p>This message was sent to ${email}. If you did not request this code, please let our <a
