...
/* ---------- Interfaces ---------- */
interface AddGCPsToBrandInput {
  gcps: string[];
  brand_id: string;
}

/* ---------- Function ---------- */
const add_gcps_to_brand = async ({ gcps, brand_id }: AddGCPsToBrandInput) => {
  const update_params: UpdateCommandInput = {
    ...
    UpdateExpression: 'ADD #gcp_list :gcps',
