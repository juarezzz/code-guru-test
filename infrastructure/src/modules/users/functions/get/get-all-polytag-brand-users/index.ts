...
/* ---------- Interfaces ---------- */
interface GetAllPolytagBrandUsersInput {
  brand_id: string;
  last_key?: string;
}

/* ---------- Function ---------- */
const get_all_polytag_brand_users = async ({
  brand_id,
  last_key,
}: GetAllPolytagBrandUsersInput) => {
  ...
  return { users: Items as User[], last_evaluated_key };
};

/* ---------- Export ---------- */
export { get_all_polytag_brand_users };
