...
export class BackendDeployPipeline extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.roles = new PipelineRoles(
      this,
      `BackendDeploy-Roles-${props.environment}`,
      {
    ...
    this.pipeline_project = new PipelineProject(
      scope,
      `BackendDeploy-PipelineProject-${props.environment}`,
      {
        projectName: `BackendDeploy-Pipeline-${props.environment}`,
        environmentVariables: get_parsed_envs({ folders: ['infra'] }),
        logging: {
          cloudWatch: {
            logGroup: new LogGroup(
              this,
              `BackendDeploy-Log-Group-${props.environment}`,
              {
          ...
          phases: {
            ...
            build: {
              ...
              commands: [
                ...
                `npx cdk deploy --all -c choice=BACK-$target_environment -c pipeline=true --require-approval never`,
              ],
            },
            ...
            post_build: {
              ...
              commands: [
                ...
                aws lambda invoke \
                  ...
                  --payload '{"success": '"$success"', "stack": "Backend", "environment": "'"$target_environment"'"}' \
                  response.json
            `,
              ],
            },
    ...
    this.pipeline = new Pipeline(
      scope,
      `BackendDeploy-Pipeline-${props.environment}`,
      {
        pipelineName: `Polytag-BackendDeploy-${props.environment}`,
