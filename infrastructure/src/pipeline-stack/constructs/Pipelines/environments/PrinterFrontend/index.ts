...
export class PrinterFrontendDeployPipeline extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.roles = new PipelineRoles(
      this,
      `PrinterFrontendDeploy-Roles-${props.environment}`,
      {
    ...
    this.pipeline_project = new PipelineProject(
      scope,
      `PrinterFrontendDeploy-PipelineProject-${props.environment}`,
      {
        projectName: `PrinterFrontendDeploy-Pipeline-${props.environment}`,
        ...
        logging: {
          cloudWatch: {
            logGroup: new LogGroup(
              this,
              `PrinterFrontendDeploy-Log-Group-${props.environment}`,
              {
          ...
          phases: {
            ...
            build: {
              ...
              commands: [
                ...
                `npx cdk deploy --all -c choice=PRINTERWEB-$target_environment -c pipeline=true --require-approval never`,
              ],
            },
            ...
            post_build: {
              ...
              commands: [
                ...
                aws lambda invoke \
                  ...
                  --payload '{"success": '"$success"', "stack": "Printer-Frontend", "environment": "'"$target_environment"'"}' \
                  response.json
            `,
              ],
            },
    ...
    this.pipeline = new Pipeline(
      scope,
      `PrinterFrontendDeploy-Pipeline-${props.environment}`,
      {
        pipelineName: `Polytag-PrinterFrontendDeploy-${props.environment}`,
    ...
    Tags.of(this.pipeline).add('Custom:Pipeline', 'Printer Frontend');
    Tags.of(this.pipeline).add('Custom:Environment', props.environment);

    Tags.of(this.pipeline_project).add('Custom:Service', 'Codebuild');
    Tags.of(this.pipeline_project).add('Custom:Pipeline', 'Printer Frontend');
