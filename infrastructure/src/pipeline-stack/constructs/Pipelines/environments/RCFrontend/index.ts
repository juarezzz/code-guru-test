...
export class RCFrontendDeployPipeline extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.roles = new PipelineRoles(
      this,
      `RCFrontendDeploy-Roles-${props.environment}`,
      {
    ...
    this.pipeline_project = new PipelineProject(
      scope,
      `RCFrontendDeploy-PipelineProject-${props.environment}`,
      {
        projectName: `RCFrontendDeploy-Pipeline-${props.environment}`,
        ...
        logging: {
          cloudWatch: {
            logGroup: new LogGroup(
              this,
              `RCFrontendDeploy-Log-Group-${props.environment}`,
              {
          ...
          phases: {
            ...
            build: {
              ...
              commands: [
                ...
                `npx cdk deploy --all -c choice=RCPORTALWEB-$target_environment -c pipeline=true --require-approval never`,
              ],
            },
            ...
            post_build: {
              ...
              commands: [
                ...
                aws lambda invoke \
                  ...
                  --payload '{"success": '"$success"', "stack": "RC-Frontend", "environment": "'"$target_environment"'"}' \
                  response.json
            `,
              ],
            },
    ...
    this.pipeline = new Pipeline(
      scope,
      `RCFrontendDeploy-Pipeline-${props.environment}`,
      {
        pipelineName: `Polytag-RCFrontendDeploy-${props.environment}`,
