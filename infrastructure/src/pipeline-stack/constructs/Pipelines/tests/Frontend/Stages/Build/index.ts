...
/* ---------- Constructs ---------- */
import { VersionedSource } from '_pipeline-stack/constructs/Pipelines/tests/Frontend/Build/Source';
...
export class BuildStageConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.versioned_source = new VersionedSource(
      this,
      `VersionedSource-Action-${props.environment}`,
      {
