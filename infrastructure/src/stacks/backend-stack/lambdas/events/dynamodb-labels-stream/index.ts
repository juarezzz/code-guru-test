...
export class DynamoDBLabelsStreamLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      scope,
      `DynamoDBLabelsStream-Lambda-${props.environment}`,
      {
        functionName: `dynamo-labels-stream-${props.environment.toLowerCase()}`,
    ...
    this.function.addEventSource(
      props.dynamodb_construct.event_sources.labels_table_event_source,
    );
