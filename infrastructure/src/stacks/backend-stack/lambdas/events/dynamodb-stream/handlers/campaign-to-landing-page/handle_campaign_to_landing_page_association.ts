...
/* ---------- Interfaces ---------- */
interface HandleCampaignToLandingPageAssociationInput {
  item: StreamRecord;
}

/* ---------- Functions ---------- */
const handle_campaign_to_landing_page_association = async ({
  item,
}: HandleCampaignToLandingPageAssociationInput) => {
  try {
    const { NewImage } = item;
    ...
    /* ----------
     * 2. Incremeting the landing page's campaigns count
     * ---------- */
    ...
    console.error('error at handle_campaign_to_landing_page_association:');
    console.error(err);
  }
};

/* ---------- Exports ---------- */
export { handle_campaign_to_landing_page_association };
