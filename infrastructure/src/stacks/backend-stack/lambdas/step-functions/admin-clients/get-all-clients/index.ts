...
export class GetAllClientsLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      scope,
      `Get-All-Clients-Step-Lambda-${props.environment}`,
      {
        ...
        functionName: `get-all-clients-step-${props.environment.toLowerCase()}`,
        handler: 'handler',
    ...
    this.case = new LambdaInvoke(
      scope,
      `Get-All-Clients-Step-Case-${props.environment}`,
      {
