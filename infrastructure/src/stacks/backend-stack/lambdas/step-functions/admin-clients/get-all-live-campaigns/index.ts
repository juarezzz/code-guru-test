...
export class GetAllLiveCampaignsLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      scope,
      `Get-All-Live-Campaigns-Step-Lambda-${props.environment}`,
      {
        ...
        functionName: `get-all-live-campaigns-step-${props.environment.toLowerCase()}`,
        handler: 'handler',
    ...
    this.case = new LambdaInvoke(
      scope,
      `Get-All-Live-Campaigns-Step-Case-${props.environment}`,
      {
