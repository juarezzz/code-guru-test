...
export class GetAllProductsLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      scope,
      `Get-All-Products-Step-Lambda-${props.environment}`,
      {
        ...
        functionName: `get-all-products-step-${props.environment.toLowerCase()}`,
        handler: 'handler',
    ...
    this.case = new LambdaInvoke(
      scope,
      `Get-All-Products-Step-Case-${props.environment}`,
      {
