...
export class GetAllUsersLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      scope,
      `Get-All-Users-Step-Lambda-${props.environment}`,
      {
        ...
        functionName: `get-all-users-step-${props.environment.toLowerCase()}`,
        handler: 'handler',
    ...
    this.case = new LambdaInvoke(
      scope,
      `Get-All-Users-Step-Case-${props.environment}`,
      {
