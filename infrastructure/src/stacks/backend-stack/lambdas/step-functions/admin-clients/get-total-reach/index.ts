...
export class GetTotalReachLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      scope,
      `Get-Total-Reach-Step-Lambda-${props.environment}`,
      {
        ...
        functionName: `get-total-reach-step-${props.environment.toLowerCase()}`,
        handler: 'handler',
    ...
    this.case = new LambdaInvoke(
      scope,
      `Get-Total-Reach-Step-Case-${props.environment}`,
      {
