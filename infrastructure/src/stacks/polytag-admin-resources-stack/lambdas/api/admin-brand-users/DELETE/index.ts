...
export class AdminBrandUsersDELETELambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Brand-Users-DELETE-Function-${props.environment}`,
      {
        bundling: {
        ...
        functionName: `admin-brand-users-delete-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
          new PolicyStatement({
