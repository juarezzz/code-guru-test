...
export class AdminBrandUsersGETLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Brand-Users-GET-Function-${props.environment}`,
      {
        bundling: {
        ...
        functionName: `admin-brand-users-get-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
          new PolicyStatement({
            actions: ['dynamodb:*'],
