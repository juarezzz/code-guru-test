...
export class AdminImageLibraryPOSTLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Image-Library-POST-Function-${props.environment}`,
      {
        ...
        functionName: `admin-image-library-post-${props.environment}`,
        handler: 'handler',
