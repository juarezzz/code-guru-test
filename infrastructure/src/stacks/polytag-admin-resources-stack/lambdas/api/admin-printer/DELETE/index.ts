...
export class AdminPrinterDELETELambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Printer-DELETE-Function-${props.environment}`,
      {
        bundling: {
        ...
        functionName: `admin-printer-delete-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
          new PolicyStatement({
