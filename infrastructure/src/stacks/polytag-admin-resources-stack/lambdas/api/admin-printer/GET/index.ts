...
export class AdminPrinterGETLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Printer-GET-Function-${props.environment}`,
      {
        bundling: {
        ...
        functionName: `admin-printer-get-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
          new PolicyStatement({
            actions: ['dynamodb:*'],
