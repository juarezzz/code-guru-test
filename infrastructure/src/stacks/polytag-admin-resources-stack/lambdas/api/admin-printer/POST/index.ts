...
export class AdminPrinterPOSTLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Printer-POST-Function-${props.environment}`,
      {
        bundling: {
        ...
        functionName: `admin-printer-post-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
          new PolicyStatement({
            actions: ['dynamodb:*'],
