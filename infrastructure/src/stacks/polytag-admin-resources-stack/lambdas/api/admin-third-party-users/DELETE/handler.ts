...
/* ---------- Functions ---------- */
import { delete_third_party_user } from '_modules/users/functions/delete/delete-third-party-user';
...
export const handler: APIGatewayProxyHandlerV2 = async (
  ...
  try {
    ...
    await delete_third_party_user({ third_party_id, third_party_user_id });

    return http_response({
      body: {
        message: 'Third party User deleted',
      },
      status_code: 200,
    });
  } catch (error) {
