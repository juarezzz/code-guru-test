...
export class AdminThirdPartyGETLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `AdminThirdParty-GET-Function-${props.environment}`,
      {
        ...
        functionName: `admin-third-party-get-${props.environment.toLowerCase()}`,
        environment: {
