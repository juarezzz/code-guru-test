...
export class AdminUsersGETLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Users-GET-Function-${props.environment}`,
      {
        bundling: {
        ...
        functionName: `admin-users-get-${props.environment.toLowerCase()}`,
        handler: 'handler',
