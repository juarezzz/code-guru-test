...
export class AdminUsersPATCHLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Users-PATCH-Function-${props.environment}`,
      {
        bundling: {
        ...
        functionName: `admin-users-patch-${props.environment}`.toLowerCase(),
        handler: 'handler',
