...
export class AdminUsersPUTLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Admin-Users-PUT-Function-${props.environment}`,
      {
        bundling: {
        ...
        functionName: `admin-users-put-${props.environment}`.toLowerCase(),
        handler: 'handler',
