...
/* ---------- Modules ---------- */
import { get_disposal_top_campaigns } from '_modules/analytics/functions/get/get-disposal-top-campaigns';
...
export const handler: APIGatewayProxyHandlerV2 = async (
  ...
  try {
    ...
    const top_campaigns = await get_disposal_top_campaigns({
      brand_id,
      gtins: gtins_array,
    ...
    console.error('Error at GET /analytics-disposal/top-campaigns');
    console.error(error);
