...
/* ---------- Modules ---------- */
import { get_disposal_top_locations } from '_modules/analytics/functions/get/get-disposal-top-locations';
...
export const handler: APIGatewayProxyHandlerV2 = async (
  ...
  try {
    ...
    const top_locations = await get_disposal_top_locations({
      gtins: gtins_array,
    ...
    console.error('Error at GET /analytics-disposal/top-locations');
    console.error(error);
