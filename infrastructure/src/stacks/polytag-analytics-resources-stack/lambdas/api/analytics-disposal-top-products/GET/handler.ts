...
/* ---------- Modules ---------- */
import { get_disposal_top_products } from '_modules/analytics/functions/get/get-disposal-top-products';
...
export const handler: APIGatewayProxyHandlerV2 = async (
  ...
  try {
    ...
    const top_products = await get_disposal_top_products({
      gtins: gtins_array,
    ...
    console.error('Error at GET /analytics-disposal/top-products');
    console.error(error);
