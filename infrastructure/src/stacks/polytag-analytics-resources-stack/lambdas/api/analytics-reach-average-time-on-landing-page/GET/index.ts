...
export class AnalyticsReachAverageTimeOnLandingPageGETLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      scope,
      `Analytics-Reach-Average-Time-On-Landing-Page-GET-Function-${props.environment}`,
      {
        ...
        functionName: `analytics-reach-average-time-on-landing-page-get-${props.environment.toLowerCase()}`,
        handler: 'handler',
    ...
    this.rule = new Rule(
      scope,
      `Analytics-Reach-Average-Time-On-Landing-Page-GET-Rule-${props.environment}`,
      {
        ruleName: `analytics-reach-average-time-on-landing-page-get-rule-${props.environment.toLowerCase()}`,
