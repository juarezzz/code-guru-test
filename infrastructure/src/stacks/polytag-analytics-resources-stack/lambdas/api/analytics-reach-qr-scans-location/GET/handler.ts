...
/* ---------- Modules ---------- */
import { get_scans_by_location } from '_modules/analytics/functions/get/get-scans-by-location';
...
export const handler: APIGatewayProxyHandlerV2 = async (
  ...
  try {
    ...
    const { scans_by_location } = await get_scans_by_location({
      gtins: gtin_array,
    ...
    console.error('Error at GET /analytics-reach/qr-scans-location');
    console.error(error);
