...
export class AnalyticsReachQRScansGETLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      scope,
      `Analytics-Reach-QR-Scans-GET-Function-${props.environment}`,
      {
        ...
        functionName: `analytics-reach-qr-scans-get-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
    ...
    this.rule = new Rule(
      scope,
      `Analytics-Reach-QR-Scans-GET-Rule-${props.environment}`,
      {
        ruleName: `analytics-reach-qr-scans-get-rule-${props.environment.toLowerCase()}`,
