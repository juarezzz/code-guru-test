...
/* ---------- Modules ---------- */
import { get_unique_users } from '_modules/analytics/functions/get/get-unique-users';
...
export const handler: APIGatewayProxyHandlerV2 = async (
  ...
  try {
    ...
    const { unique_users } = await get_unique_users({
      gtins: gtin_array,
    ...
    console.error('Error at GET /analytics-reach/unique-users');
    console.error(error);
