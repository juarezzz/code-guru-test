...
export class BrandUsersPUTLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Brand-Users-PUT-Function-${props.environment}`,
      {
        ...
        functionName: `brand-users-put-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
          new PolicyStatement({
