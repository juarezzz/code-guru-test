...
export class ImageLibraryGETLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `ImageLibrary-GET-Function-${props.environment}`,
      {
        ...
        functionName: `image-library-get-${props.environment.toLowerCase()}`,
