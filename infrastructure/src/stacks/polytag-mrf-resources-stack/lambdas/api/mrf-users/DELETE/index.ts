...
export class MrfUsersDELETELambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Mrf-Users-DELETE-Function-${props.environment}`,
      {
        ...
        functionName: `mrf-users-delete-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
          new PolicyStatement({
