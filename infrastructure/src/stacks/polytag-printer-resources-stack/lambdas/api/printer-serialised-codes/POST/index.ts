...
export class PrinterSerialisedCodesPOSTLambda extends Construct {
  ...
  constructor(scope: Construct, id: string, props: Props) {
    ...
    this.function = new NodejsFunction(
      this,
      `Printer-SerialisedCodes-POST-Function-${props.environment}`,
      {
        ...
        functionName: `printer-serialised-codes-post-${props.environment.toLowerCase()}`,
        handler: 'handler',
        initialPolicy: [
          new PolicyStatement({
